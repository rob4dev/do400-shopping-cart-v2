...
The application is now runnable using `java -jar target/shopping-cart-1.0-SNAPSHOT-runner.jar`.
...
If you want to learn more about building native executables, please consult https://quarkus.io/guides/building-native-image.# do400-shopping-cart-v2
